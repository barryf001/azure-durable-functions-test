...
namespace TestLib
{
    public class Class1
    {
        ...
        const string NEW_FUNCTIONALITY_7="NEW_FUNCTIONALITY_7";
        const string NEW_FUNCTIONALITY_8="NEW_FUNCTIONALITY_8";
        const string NEW_FUNCTIONALITY_9="NEW_FUNCTIONALITY_9";
